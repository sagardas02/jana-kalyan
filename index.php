    ...
    <div class="swiper-container thm-swiper__slider" data-swiper-options='{"slidesPerView": 1, "loop": true,
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <div class="image-layer-four" style="background-image: url(assets/img/Slider/slider1.jpg);"></div>
                <!-- /.image-layer -->
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="main-slider-four__content">
                                <h2 class="main-slider-four__title">Help to Feed a Family.</h2>
                                <p class="main-slider-four__text">We are here to support you every step of the
                                    way</p>
            ...
            <div class="swiper-slide">
                <div class="image-layer-four" style="background-image: url(assets/img/Slider/slider2.jpg);"></div>
                <!-- /.image-layer -->
            ...
            <div class="swiper-slide">
                <div class="image-layer-four" style="background-image: url(assets/img/Slider/slider3.jpg);"></div>
                <!-- /.image-layer -->
            ...
            <div class="col-xl-6">
                <div class="about-three__left">
                    ...
                    <p class="about-three__text">Lorem ipsum dolor sit amet, consectetur adipisicing sed
                        ...
                        nunc dictum. Lorem ipsum dolor sit amet consectetur adipisicing elit. Tenetur, perferendis in
                        neque nam optio itaque recusandae totam a dolores cumque incidunt perspiciatis explicabo
                        accusamus, rem excepturi adipisci? Eius libero magnam corrupti quo vel blanditiis aliquid amet
                        hic reiciendis minus, quod eaque sed quibusdam tempore repellendus minima beatae voluptatem
                        dignissimos! .</p>
...
<section class="help-one">
    <div class="help-one__shape-1 float-bob-x">
        <img src="assets/images/shapes/help-one-shape-1.png" alt="">
    </div>
    <div class="container">
        <div class="row">
            <div class="col-xl-6">
                <div class="help-one__left">
                    <div class="help-one__img-box">
                        <div class="help-one__img">
                            <img src="assets/img/why-c-us-1.jpg" alt="">
                        </div>
                        <div class="help-one__img-2">
                            <img src="assets/img/why-c-us-2.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-6">
                <div class="help-one__right">
                    <div class="section-title text-left">
                        ...
                        <h2 class="section-title__title">Help Each Other can
                            Change World</h2>
                    </div>
...
<section class="blog-two">
    <div class="blog-two__bg-box">
        <div class="blog-two__bg" style="background-image: url(assets/images/backgrounds/blog-two-bg-img.png);">
        </div>
    </div>
    <div class="container">
            ...
            <div class="owl-carousel1 owl-carousel">
                    ...
                    <div class="blog-one__single">
                        <div class="blog-one__img-box">
                            <div class="blog-one__img">
                                <img src="https://picsum.photos/383/299" alt="Blog Image">
                            </div>
                        </div>
                        <div class="blog-one__content-box">
                            <h3 class="blog-one__title">
                                <a href="#">Online legal advice for asylum seekers in Greece</a>
                            </h3>
                ...
                <div class="item" data-wow-delay="100ms"
                    ...
                    <div class="blog-one__single">
                        ...
                        <div class="blog-one__content-box">
                            <h3 class="blog-one__title">
                                <a href="#">Legal support for refugees in Europe</a>
                            </h3>
                            <div class="blog-one__read-more">
                                <a href="#">
                                    <span class="fa fa-angle-right"></span>Read More
                ...
                <div class="item" data-wow-delay="100ms"
                    ...
                    <div class="blog-one__single">
                        ...
                        <div class="blog-one__content-box">
                            <h3 class="blog-one__title">
                                <a href="#">Human rights advocacy in the Middle East</a>
                            </h3>
                            <div class="blog-one__read-more">
                                <a href="#">
                                    <span class="fa fa-angle-right"></span>Read More
